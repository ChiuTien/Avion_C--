...
template <> constexpr inline auto Views::ChronometreWidget::qt_create_metaobjectdata<qt_meta_tag_ZN5Views17ChronometreWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'tempsMisAJour'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'tickPhysique'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'simulationDemarree'
        QtMocHelpers::SignalData<void()>(4, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'simulationArretee'
        QtMocHelpers::SignalData<void()>(5, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'incrementerTemps'
...
void Views::ChronometreWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->tempsMisAJour(); break;
        case 1: _t->tickPhysique(); break;
        case 2: _t->simulationDemarree(); break;
        case 3: _t->simulationArretee(); break;
        case 4: _t->incrementerTemps(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ChronometreWidget::*)()>(_a, &ChronometreWidget::tempsMisAJour, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ChronometreWidget::*)()>(_a, &ChronometreWidget::tickPhysique, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ChronometreWidget::*)()>(_a, &ChronometreWidget::simulationDemarree, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (ChronometreWidget::*)()>(_a, &ChronometreWidget::simulationArretee, 3))
            return;
    }
...
// SIGNAL 0
void Views::ChronometreWidget::tempsMisAJour()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Views::ChronometreWidget::tickPhysique()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Views::ChronometreWidget::simulationDemarree()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Views::ChronometreWidget::simulationArretee()
{
